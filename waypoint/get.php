...
function waypoint($lon, $lat, $height, $weight, $dist, $brng, $t_weight){
...
function getwaypoin($drone, $lat, $lon, $radius, $altitude){
    ...
    switch ($drone) {
        case 1:
            ...
            $t_weight = $radius * 2;
            $height = 2 * $radius;
            $waypoint1 = waypoint($lon, $lat, $height, $weight, $dist, $brng, $t_weight);
        ...
        case 2:
            for($i=1; $i<=$drone; $i++){
                ...
                if($i==1){
                    ...
                    $brng = 180;
                    $dist = $radius;
                    $waypoint2 = waypoint($lon, $lat, $height, $weight, $dist, $brng, $t_weight);
        ...
        case 3:
            for($i=1; $i<=$drone; $i++){
                ...
                if($i==1){
                    ...
                    $brng = 180 - rad2deg(atan(($radius / 3) / $radius));
                    $dist = (pow(10, 0.5) * $radius) / 3;
                    $waypoint3 = waypoint($lon, $lat, $height, $weight, $dist, $brng, $t_weight);
        ...
        case 4:
            for($i=1; $i<=$drone; $i++){
                ...
                if($i==1){
                    ...
                    $brng = 0;
                    $dist = 0;
                    $waypoint4 = waypoint($lon, $lat, $height, $weight, $dist, $brng, $t_weight);
